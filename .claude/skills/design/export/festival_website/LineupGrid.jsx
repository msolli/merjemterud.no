...
const ARTISTS = [
  ...
  { name: 'Tusmørke', tag: 'prog · psych · norrønt', day: 'LØR', time: '21:00', stage: 'STORSAL', tags: ['prog','psych','folk'], photo: window.__resources.bandTusmorke },
  { name: 'Svartskog Spelemannslag', tag: 'hardingfele · drone folk', day: 'SØN', time: '15:00', stage: 'BRYGGA', tags: ['folk','drone'], photo: window.__resources.bandSpelemann },
  ...
  { name: 'Arnfinn Nesset', tag: 'mystisk ny tilskudd', day: 'FRE', time: '19:00', stage: 'STORSAL', tags: ['?','mystery'], photo: window.__resources.bandArnfinn },
